...
export default function ElibHome() {
    ...
    const renderArrivals = ({ item }) => (
        <View className="w-36 h-full p-6 pr-1 pt-0 pb-0 relative">
            ...
            <TouchableOpacity className="ml-4 w-[115%] h-full absolute" onPress={() => handelBookPress(item)}>
            ...
            <ScrollView className="bg-gray-100 h-full w-full pl-8 pr-8">
                <View className="flex flex-row items-end w-full h-48">
                    ...
                    <View className="flex w-36 h-36 ml-8 items-end justify-end">
                        <Image className="w-full h-full" source={require('./../assets/images/reading.png')} />
                    </View>
                </View>
                <View className="flex flex-row bg-white space-x-6 w-full h-fit p-4 rounded-2xl shadow-md">
                    <Image className="h-6 w-6  placeholder-gray-500" source={require('./../assets/images/icons/search.png')} />
                    <TextInput className=" " placeholder='Search for Books...' placeholderTextColor="#9CA3AF">
                ...
                <View className="h-fit w-full my-6">
                    ...
                    <FlatList
                            ...
                            className='w-[120%] h-54 mt-4 -left-8' horizontal={true}/>
                </View>
                <View className="w-full h-32 rounded-2xl">
                    ...
                    <View className="w-full h-32 bg-white top-2 rounded-2xl shadow-xl">
                        <Image className="rounded-xl h-full w-full" source={require('./../assets/images/bestbooks.png')} />
                    </View>
                </View>
            </ScrollView>
           {/* <View className="absolute w-full h-20 bottom-6 pr-4 pl-4"> 
                <View  className="flex flex-columns w-full h-full bg-white rounded-3xl shadow-xl">
                    <View className="w-1/4 h-full">
                        <TouchableOpacity className="w-full h-full  items-center justify-center" onPress={()=> navigation.push('ElibProfile')}>
                            <Image className="w-10 h-10" source={require('./../assets/images/icons/people.png')}  />
                        </TouchableOpacity>
                    </View>
                </View>
    </View>*/}
